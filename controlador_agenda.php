...
function excluirContato($id){//a função sera irá pegar o contato pela sua id e excluir ela para não ser mais exibida
...
function enviar_header(){//função para redirecionar os dados para página inicial
